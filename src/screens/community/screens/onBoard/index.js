...
import { CommunityOnBoardData } from '../../../../utils/helper';
...
const CommunityOnBoard = (props) => {
    ...
    const handleNext = () => {
        if (index < CommunityOnBoardData.length - 1) {
    ...
    return (
        <View style={styles.mainContain}>
            ...
            <Swiper
                ...
                key={CommunityOnBoardData?.length}
            ...
            <Row style={index === 2 ? styles.footerView2 : styles.footerView1}>
                {index !== 2 && <ButtonComponent
                    label={'Skip'}
                    onPress={() => {
                        props.navigation.navigate("CommunityWelcomeScreen")
                    }}
